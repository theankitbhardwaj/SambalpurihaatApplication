...
class PromotedProductsAdapter : RecyclerView.Adapter<PromotedProductsAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.apply {
            ...
            Log.e("TAG", "onBindViewHolder: ${item.variants[variantNumber].image[imageNumber]}")
